...
public class StayDto {
    ...
    private Long id;
    private GuestPersonalDetails guestPersonalDetails = new GuestPersonalDetails();
    private StayDetails stayDetails = new StayDetails();

    public class GuestPersonalDetails {
    ...
    public GuestPersonalDetails getGuestPersonalDetails() {
        return guestPersonalDetails;
    }

    public void setGuestPersonalDetails(GuestPersonalDetails guestPersonalDetails) {
        this.guestPersonalDetails = guestPersonalDetails;
    }
